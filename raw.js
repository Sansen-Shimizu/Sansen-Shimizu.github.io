...
//====================================================================================================================================
			...
			function init() {
				...
				object = new THREE.Mesh( clothGeometry2, blackMaterial );
				object.position.set( 0, 0, 0 );
				object.castShadow = true;
				scene.add( object );
				...
				gltfLoader.load( 'https://uploads-ssl.webflow.com/6152c4ba477fccf758106a16/616cc304fd01d0580034403f_sansenchanNLAfixed.glb.txt', function ( gltf ) {
					if(backupImage != null)
